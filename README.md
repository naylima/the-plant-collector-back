# the-plant-collector-back

Back-end for The Plant Collector, an plant and acssessories e-commerce.
...
Set `POSTGRES_HOST` to `plantshop_db` for `.env.development`. It is the name of the postgres container inside docker-compose file. Docker Compose will start the postgres container for you, create the database and host alias for you.
